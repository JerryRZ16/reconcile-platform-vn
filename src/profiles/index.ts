...
import { idProfile } from './id'
import { phProfile } from './ph'
...
/** 当前可用国家（越南 + 泰国 + 马来 + 印尼 + 菲律宾；后续国家按配置文件扩展） */
export const countries: CountryProfile[] = [vnProfile, thProfile, myProfile, idProfile, phProfile]
